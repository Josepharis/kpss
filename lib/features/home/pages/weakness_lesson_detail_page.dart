      ...
      child: ClipRRect(
        child: Stack(
          children: [
            ...
            // 3. Content
            Container(
              padding: EdgeInsets.fromLTRB(20, statusBarHeight + 4, 20, 8),
              child: Column(
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final weaknessCount = _groupedByTopic[topicName]!.length;
          return _buildTopicCard(isDark, topicName, weaknessCount, color);
        },
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Bu derste henüz eksik sorunuz bulunmuyor.',
